      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            {/* Timeline line */}
            <div className="absolute left-0 md:left-1/2 transform md:-translate-x-px h-full w-0.5 bg-gradient-to-b from-primary via-secondary to-transparent"></div>

            <Card className="bg-card border-primary/20 p-8 hover:shadow-glow transition-all duration-300 animate-fade-in relative">
              ...
              <div className="md:ml-8">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                  <div className="flex items-center gap-3 mb-2 md:mb-0">
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-foreground">Data Analyst</h3>
                ...
                <div className="space-y-3 mt-6">
                  <p className="text-muted-foreground font-semibold mb-4">Key Achievements:</p>
